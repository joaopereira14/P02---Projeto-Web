	...
	function wp_theme_widgets_init() {
		...
		*/
		function wp_theme_scripts() {
			...
			wp_enqueue_script( 'jquery', get_template_directory_uri() . 'https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js', array ( 'jquery' ), 1.1, true);

			wp_enqueue_script( 'bootstrap', get_template_directory_uri() . 'js/bootstrap.min.js', array ( 'jquery' ), 1.1, true);

			wp_enqueue_script( 'magnific-popup', get_template_directory_uri() . 'js/jquery.magnific-popup.js', array ( 'jquery' ), 1.1, true);

			wp_enqueue_script( 'me', get_template_directory_uri() . 'js/me.js', array ( 'jquery' ), 1.1, true);
